...
[아이템 21. 인터페이스는 구현하는 쪽을 생각해 설계하라](https://github.com/Jinnie-J/effective-java-study/blob/main/04장/아이템_21/인터페이스는_구현하는_쪽을_생각해_설계하라.md) |
...
| 아이템
:---: |
[아이템 34. int 상수 대신 열거 타입을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_34/int_상수_대신_열거_타입을_사용하라.md)|
[아이템 35. ordinal 메서드 대신 인스턴스 필드를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_35/ordinal_메서드_대신_인스턴스_필드를_사용하라.md)|
[아이템 36. 비트 필드 대신 EnumSet을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_36/비트_필드_대신_EnumSet을_사용하라.md)|
[아이템 37. ordinal 인덱싱 대신 EnumMap을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_37/ordinal_인덱싱_대신_EnumMap을_사용하라.md)|
[아이템 38. 확장할 수 있는 열거 타입이 필요하면 인터페이스를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_38/확장할_수_있는_열거_타입이_필요하면_인터페이스를_사용하라.md)|
[아이템 39. 명명 패턴보다 애너테이션을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_39/명명_패턴보다_애너테이션을_사용하라.md)|
[아이템 40. @Override 애너테이션을 일관되게 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_40/%40Override_애너테이션을_일관되게_사용하라.md)|
[아이템 41. 정의하려는 것이 타입이라면 마커 인터페이스를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/06장/아이템_41/정의하려는_것이_타입이라면_마커_인터페이스를_사용하라.md)|


### 7장
| 아이템
:---: |
[아이템 42. 익명 클래스보다는 람다를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_42/익명_클래스보다는_람다를_사용하라.md)|
[아이템 43. 람다보다는 메서드 참조를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_43/람다보다는_메서드_참조를_사용하라.md)|
[아이템 44. 표준 함수형 인터페이스를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_44/표준_함수형_인터페이스를_사용하라.md)|
[아이템 45. 스트림은 주의해서 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_45/스트림은_주의해서_사용하라.md)|
[아이템 46. 스트림에서는 부작용 없는 함수를 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_46/스트림에서는_부작용_없는_함수를_사용하라.md)|
[아이템 47. 반환 타입으로는 스트림보다 컬렉션이 낫다](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_47/반환_타입으로는_스트림보다_컬렉션이_낫다.md)|
[아이템 48. 스트림 병렬화는 주의해서 적용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/07장/아이템_48/스트림_병렬화는_주의해서_적용하라.md)|


### 8장
| 아이템
:---: |
[아이템 49. 매개변수가 유효한지 검사하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_49/매개변수가_유효한지_검사하라.md)|
[아이템 50. 적시에 방어적 복사본을 만들라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_50/적시에_방어적_복사본을_만들라.md)|
[아이템 51. 메서드 시그니처를 신중히 설계하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_51/메서드_시그니처를_신중히_설계하라.md)|
[아이템 52. 다중정의는 신중히 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_52/다중정의는_신중히_사용하라.md)|
[아이템 53. 가변인수는 신중히 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_53/가변인수는_신중히_사용하라.md)|
[아이템 54. null이 아닌, 빈 컬렉션이나 배열을 반환하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_54/null이_아닌_빈_컬렉션이나_배열을_반환하라.md)|
[아이템 55. 옵셔널 반환은 신중히 하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_55/옵셔널_반환은_신중히_하라.md)|
[아이템 56. 공개된 API 요소에는 항상 문서화 주석을 작성하라](https://github.com/Jinnie-J/effective-java-study/blob/main/08장/아이템_56/공개된_API_요소에는_항상_문서화_주석을_작성하라.md)|


### 9장
| 아이템
:---: |
[아이템 57. 지역변수의 범위를 최소화하라](https://github.com/Jinnie-J/effective-java-study/blob/main/09장/아이템_57/지역변수의_범위를_최소화하라.md)|
[아이템 58. 전통적인 for 문보다는 for-each 문을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/09장/아이템_58/전통적인_for문보다는_for-each문을_사용하라.md)|
[아이템 59. 라이브러리를 익히고 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/09장/아이템_59/라이브러리를_익히고_사용하라.md)|
[아이템 60. 정확한 답이 필요하다면 float과 double은 피하라](https://github.com/Jinnie-J/effective-java-study/blob/main/09장/아이템_60/정확한_답이_필요하다면_float와_double은_피하라.md)|
[아이템 61. 박싱된 기본 타입보다는 기본 타입을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/09장/아이템_61/박싱된_기본_타입보다는_기본_타입을_사용하라.md)|
...
| 아이템
:---: |
[아이템 69. 예외는 진짜 예외 상황에만 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/10장/아이템_69/예외는_진짜_예외_상황에만_사용하라.md)|
...
[아이템 83. 지연 초기화는 신중히 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/11장/아이템_83/지연_초기화는_신중히_사용하라.md)|
[아이템 84. 프로그램의 동작을 스레드 스케줄러에 기대지 말라](https://github.com/Jinnie-J/effective-java-study/blob/main/11장/아이템_84/프로그램의_동작을_스레드_스케줄러에_기대지_말라.md)|

### 12장
| 아이템
:---: |
[아이템 85. 자바 직렬화의 대안을 찾으라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템_85/자바_직렬화의_대안을_찾으라.md)|
[아이템 86. Serializable을 구현할지는 신중히 결정하라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템86/Serializable을_구현할지는_신중히_결정하라.md)|
[아이템 87. 커스텀 직렬화 형태를 고려해보라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템87/커스텀_직렬화_형태를_고려해보라.md)|
[아이템 88. readObject 메서드는 방어적으로 작성하라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템_88/readObject_메서드는_방어적으로_작성하라.md)|
[아이템 89. 인스턴스 수를 통제해야 한다면 readResolve 보다는 열거 타입을 사용하라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템89/인스턴스_수를_통제해야_한다면_readResolve보다는_열거_타입을_사용하라.md)|
[아이템 90. 직렬화된 인스턴스 대신 직렬화 프록시 사용을 검토하라](https://github.com/Jinnie-J/effective-java-study/blob/main/12장/아이템_90/직렬화된_인스턴스_대신_직렬화_프록시_사용을_검토하라.md)|
